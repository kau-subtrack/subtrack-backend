...
import { getHomeInfo, getPickupList, completePickup, getDeliveryList, patchDelivery, /*getRouteInfo, postRouteRequest*/ } from "../controllers/driverControllers.js";
...
router.patch('/delivery/completed', patchDelivery); // 배송 정보 변경 요청
